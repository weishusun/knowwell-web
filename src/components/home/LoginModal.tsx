  ...
  return createPortal(
    ...
    >
      <div className="relative w-full max-w-xl overflow-hidden rounded-2xl border border-white/10 bg-black text-white shadow-[0_25px_70px_rgba(0,0,0,0.35)]">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 px-8 pb-10 pt-8">
            ...
            <div className="space-y-4">
              <label className="block text-sm text-gray-300">
                ...
                <select
                  ...
                  className="w-full rounded-xl bg-black text-white border border-white/10 px-4 py-3 text-sm outline-none transition focus:border-purple-500/70"
                >
                  ...
                  <option value="china" className="bg-black text-white">
                    China (+86)
                  </option>
                  <option value="uk" className="bg-black text-white">
                    United Kingdom (+44)
                  </option>
                  <option value="australia" className="bg-black text-white">
                    Australia (+61)
                  </option>
                </select>
              </label>
